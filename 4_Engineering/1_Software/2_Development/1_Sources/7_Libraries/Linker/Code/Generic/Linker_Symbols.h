...
/** \brief     Linker script symbol defining the RAM start address where the initialized global variables from the
 *             .data section are placed. */
...
/** \brief     Linker script symbol defining the RAM start address where the uninitialized global variables from the
 *             .bss section are placed. */
 ...
 *             pointer) is placed. The stack head address is higher than the stack tail. */
